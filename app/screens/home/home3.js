...
import PostCreationScreen from '../../screens/postCreation/postCreation.js';
import TimeSelectionScreen from '../../screens/timeSelection/timeSelection.js';
...
const PostCreationModalStackNavigator = createStackNavigator(
  {
    PostCreationScreen: PostCreationScreen,
    TimeSelectionScreen: TimeSelectionScreen
  },
  {
    headerMode: 'screen',
    mode: 'modal',
    initialRouteName: 'PostCreationScreen',
    navigationOptions: ({ navigation }) => ({
...
const ModalStackNavigator = createStackNavigator(
  {
    ...
    PostEventModal: { screen: PostCreationModalStackNavigator }
  },
  {
    mode: 'modal',
    headerMode: 'None',
